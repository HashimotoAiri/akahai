...
$site_top = "https://akahaiagent.jp/b/";
...
<html lang="ja">
  <head>
    ...
    <meta name="description" content="優しさ・思いやりで結ぶエージェントサービスakahai　未経験者でもOK！リスティング広告運用で月25万！？Excelが使える！PCが得意な方募集！">
    <meta name="keywords" content="Webマーケティング,インターネットマーケティング,リスティング運用,広告運用,転職,正社員,派遣,アルバイト,人材派遣,求人情報,資格,未経験者,高時給,高収入,安定,akahai,">
    <meta name="format-detection" content="telephone=no">
    <title>akahai | 未経験者歓迎！リスティング広告の人材募集！</title>
    ...
    <header>
      ...
      <section id="section01">
        ...
        <div class="section01-main">
          <div class="section01-1">
            <img src="common/img/section1_2_1.png">
          </div>
          <div class="section01-2">
            <img src="common/img/section1_2_2.png">
            <p><span class="a">インターネットで検索した時に</span><br>
            <span class="b"><span class="c">上</span>や<span class="d">横</span>に出てくる<span class="e">広告</span></span></p>
            <p>検索エンジン（Yahoo!やgoogleなど）で<br>ユーザーがあるキーワードで検索した時に、<br>その検索結果に連動して表示される広告のこと。</p>
          </div>
          <div class="section01-2sp">
            <img src="common/img/section1_2_2_sp.png">
          </div>
        </div>
        <div class="section01-3">
          <p>リスティング広告の管理や運営する人の<br>
            基本の仕事は<img src="common/img/section1_3_1.png"><img src="common/img/section1_3_2.png">です。</p>
        </div>
        <div class="section01-3sp">
          <img src="common/img/section1_3_sp.png">
        </div>
        <div class="section01-4">
          <img src="common/img/section1_4.png">
        </div>
        <div class="section01-5">
          <img src="common/img/section1_5.png">
        </div>
        <div class="section01-6">
          <a href="#section05"><img src="common/img/section_btm.png" alt="転職・派遣サポートへの登録はこちら！"></a>
        </div>
      </section>

      <section id="section02">
        <h2><img src="common/img/section2_1_h2.png" alt="未経験者でも安心！スキルに応じた給料と選べる働き方"></h2>
        ...
        <div class="section02-2main">
          <div class="section02-2">
            ...
            <p class="f">クライアントのWEB集客のメインサービスがリスティング広告であるからこそ、<br>こちらのお給料が頂けています。<br>そのため、責任も重くなりますが、間違いなくやりがいのある仕事だといえます。</p>
          </div>
          <div class="section02-3">
            <h4>そんな責任の重い仕事なのに未経験で大丈夫か…？</h4>
            <img src="common/img/section2_3_2.png">
            <div class="section02-3-1">
              <h5>リスティング広告を一から丁寧に監修</h5>
                <p>クライアントが納得するレベルに達するまで、<br>しっかりと教育研修を行います。</p>
            </div>
            <div class="section02-3-2">
              <h5>転職・派遣後にもakahaiからのサポートがあるため安心</h5>
                <p>分からないことがあった場合には、専用窓口へ気軽に質問ができます。<br>過去に実施した研修を再度受けることも自由。</p>
            </div>
          </div>
        </div>
        ...
        <div class="section02-4main">
          <div class="section02-4-1">
            <p>さらに！<br>
            クライアントから信頼されている理由！</p>
          </div>
          <div class="section02-4-1sp">
            <img src="common/img/section2_4_sp.png">
          </div>
          <div class="section02-4-2">
            <p>転職・派遣の前には、必ず<br><img src="common/img/section2_5_1.png"><img src="common/img/section2_5_2.png">の<br>資格を取得して頂きます。</p>
          </div>
          <div class="section02-4-2sp">
            <img src="common/img/section2_5_sp.png">
          </div>
          <div class="section02-4-3">
            <p>※リスティング広告運用専門の認定試験。リスティング広告運用担当を求めている企業には<br>非常に有効な資格となります。また、広告運用経験がなければ、この資格は取得できません。<br>運用をしっかりとしたことがあるという、企業からの信頼にもつながります。</p>
            <img src="common/img/section2_5_3.png">
          </div>
          <div class="section02-4-3sp">
            <img src="common/img/section2_txt_sp.png">
            <img src="common/img/section2_5_3.png">
          </div>
          <div class="section02-4-4">
            <p>だから、<img src="common/img/section2_5_4.png">での転職が可能♪</p>
          </div>
          <div class="section02-4-4sp">
            <img src="common/img/section2_5_4_sp.png">
          </div>
        </div>
        <div class="section02-5">
      ...
      <section id="section04">
        ...
        <div class="section04-2sp">
            <img src="common/img/section4_2_4_sp.png">
        </div>
...
<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>?thanks=2" method="POST">
